...
if (get_option(get_option_name('activated')) || get_option(get_option_name('purchase_code'))) {
	...
	curl_setopt($ch, CURLOPT_URL, 'https://a.elfsight.com/updates/v1/?action=deactivate&slug=' . PLUGIN_SLUG . '-cc&host=' . parse_url(site_url(), PHP_URL_HOST) . '&version=4.0.2&purchase_code=' . get_option(get_option_name('purchase_code')));
